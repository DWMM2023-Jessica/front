...
<body>
    <header>
        ...
        <div class="menu">
                ...
                <ul>   
                    <li><a href="#real" class="real">Réalisations</a></li>
        ...
        <div class="dropdown_menu">
            <li><a href="#qui">Accueil</a></li>
            <li><a href="#qui">Qui suis-je</a></li>
            <li><a href="#tabreal">Réalisations</a></li>
            <li><a href="#contact">Contact</a></li>
        </div>
    </header>
...
<button type="button" class="btn1 btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Vos devis garantie sous 15 jours*</h1>
    ...
    <section class="quisuisje" id="qui">
        <div class="contnr">
            <div class="H1">
            ...
            <div class="wor">
              <div class="imgheader"><div class="image"><img src="img/IMG_20230831_091803.jpg" alt="image qui sui je"></div></div>
    ...
    <section class="nospartenaires" id="contact">
